...
})({"eNFJy":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "4f480214ab450da7";
"use strict";
...
},{}],"3VCPU":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Favorite Image Function
parcelHelpers.export(exports, "favourite", ()=>favourite);
...
// Axios Interceptors
(0, _axiosDefault.default).interceptors.request.use((config)=>{
...
async function initialLoad() {
    try {
        const res = await (0, _axiosDefault.default).get("/breeds");
        const breeds = res.data;
        breedSelect.innerHTML = breeds.map((breed)=>`<option value="${breed.id}">${breed.name}</option>`).join("");
        if (breeds.length > 0) loadBreedImages(breeds[0].id);
    } catch (error) {
...
async function loadBreedImages(breedId) {
    try {
        _carouselJs.clear();
        infoDump.innerHTML = "";
        const res = await (0, _axiosDefault.default).get(`/images/search?breed_ids=${breedId}&limit=5`, {
        ...
        images.forEach((img)=>{
            const carouselItem = _carouselJs.createCarouselItem(img.url, "Cat Image", img.id);
            _carouselJs.appendCarousel(carouselItem);
        });
...
async function favourite(imgId) {
    try {
        const favResponse = await (0, _axiosDefault.default).post("/favourites", {
            image_id: imgId
        });
...
async function getFavourites() {
    try {
        const res = await (0, _axiosDefault.default).get("/favourites");
        const favourites = res.data;
        _carouselJs.clear();
        infoDump.innerHTML = "<h3>Your Favorites</h3>";
        favourites.forEach((fav)=>{
            const carouselItem = _carouselJs.createCarouselItem(fav.image.url, "Favorite Cat", fav.image_id);
            _carouselJs.appendCarousel(carouselItem);
        });
        _carouselJs.start();
    } catch (error) {
...
document.addEventListener("DOMContentLoaded", function() {
    const dropdown = document.getElementById("yourDropdownID"); // Replace with actual dropdown ID
...
},{"./Carousel.js":"kZr22","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eNFJy","3VCPU"], "3VCPU", "parcelRequire94c2")

//# sourceMappingURL=index.ab450da7.js.map
